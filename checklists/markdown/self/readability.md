...
### Verify code is well-commented and self-documenting

- Ensure complex logic is explained, function purposes are documented, and business rules are clarified for future maintainers.
...
### Check variable and function names are descriptive

- Ensure all variable and function names reflect their purpose, avoid abbreviations, and follow consistent naming conventions.
...
- Ensure functions follow single responsibility principle, have reasonable length, and have clear input/output.
...
- Ensure consistent indentation, proper spacing, and line length limits are respected according to project standards.
