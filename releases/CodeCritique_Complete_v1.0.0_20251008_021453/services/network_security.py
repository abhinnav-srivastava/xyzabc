...
class NetworkSecurityService:
    ...
    def is_connection_allowed(self, host: str, port: int, protocol: str = "tcp") -> Tuple[bool, str]:
        ...
        # Check if external connections are blocked
    ...
    def _is_domain_allowed(self, host: str) -> bool:
        ...
        # If no allowed domains specified, allow all (subject to other checks)
    ...
    def _is_ip_allowed(self, host: str) -> bool:
        ...
        # If no allowed IPs specified, allow all (subject to other checks)
        if not allowed_ips:
            return True
    ...
    def _is_port_allowed(self, port: int) -> bool:
        ...
        # If no allowed ports specified, allow all (subject to other checks)
    ...
    def validate_request(self, request_host: str, request_port: int = None) -> Tuple[bool, str]:
        ...
        if request_port is None:
            request_port = 5000  # Default Flask port
